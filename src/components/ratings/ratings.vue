<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
     <ratingselect :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="ratings" @selectTypeEvent="ratingTypeFn" @contentToggle="contentToggle"></ratingselect>
